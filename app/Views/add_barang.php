...
<div id="content">
    ...
    <!-- End of Topbar -->
         ...
         <h1 class="h3 mb-0 text-gray-800 m-0">FORM DATA BARANG</h1>
         </div>
    ...
    <div class="container-fluid" style="display: flex; justify-content: center; align-items: center;">
        ...
        <input type="text" name="nama_barang" id="nama_barang" required> -->
            ...
            <div class="input-group mb-3" style="width:850px; border: 3px solid #00A9FF; border-radius: 5%;">
                <span class="input-group-text" id="inputGroup-sizing-default">Jumlah Unit</span>
                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="jumlah_unit" id="jumlah_unit" inputmode="numeric">
            </div>
